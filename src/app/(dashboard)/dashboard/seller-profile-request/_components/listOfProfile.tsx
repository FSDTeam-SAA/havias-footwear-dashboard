...
const ListOfProfile = () => {
  ...
  const deleteSellerMutation = useMutation({
    mutationFn: async (sellerId: string) => {
      const res = await fetch(
        `${process.env.NEXT_PUBLIC_BACKEND_URL}/seller/${sellerId}`,
        {
          method: "DELETE",
          headers: {
            "Content-Type": "application/json",
  ...
  return (
    <div>
      ...
      <div className="flex justify-between pb-7">
         <Title title="Seller management" active="Dashboard > Seller management > List" />
            ...
            <Table className="w-full">
              <TableHeader>
                <TableRow className="border-b border-t border-[#B6B6B6]">
                  <TableHead className="text-center py-4 font-semibold text-gray-700 text-[18px] uppercase tracking-wide w-40">
                    Seller Name
                  </TableHead>
                  <TableHead className="text-center py-4 font-semibold text-gray-700 text-[18px] uppercase tracking-wide w-40">
                    Status
              ...
              <TableBody>
                {paginatedSellers.map((seller) => (
                  <TableRow key={seller._id} className="border-[#B6B6B6]">
                    ...
                    <TableCell className="text-center py-4 text-base font-medium">
                    ...
                    <TableCell className="text-center px-4 py-4">
                      <div className="flex justify-center items-center gap-2">
                        ...
                        >
                          <SelectTrigger className="w-[120px] text-base rounded-full h-8">
                        ...
                        <Button
                          variant="ghost"
                          size="sm"
                          className="h-8 ml-1.5 px-2 hover:bg-blue-100 hover:text-blue-600 transition-colors"
                          title="View Details"
                          onClick={() => {
