  ...
  return (
    <div>
      ...
      <div className="w-full mt-6">
            ...
            <TableBody>
              {isLoading ? (
                ...
                Array.from({ length: itemsPerPage }).map((_, idx) => (
                  <TableRow
                    key={idx}
                    className="animate-pulse border-b border-t border-[#B6B6B6]"
                  >
                ...
                sellers.map((seller) => (
                  ...
                  >
                    <TableCell className="text-center text-base font-medium text-[#595959]">
        ...
        {/* ✅ Pagination */}
        {meta && meta.total > 10 && (
          <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between px-6 py-4 border-t">
