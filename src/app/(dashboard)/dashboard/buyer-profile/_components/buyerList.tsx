  ...
  return (
    <div>
      ...
      <div className="flex justify-between items-center border-[#B6B6B6] pb-7">
        <Title
          title="Buyer Profile"
          active="Dashboard > Buyer Profile > List"
        />
          ...
          <Table className="w-full">
            <TableHeader>
              <TableRow className=" border-[#B6B6B6] border-b border-t ">
                ...
                <TableHead className="text-center font-medium text-[18px] text-[#1C2228] uppercase tracking-wide py-4 w-40">
                  User Name
                </TableHead>
                <TableHead className="text-center py-4 w-32 font-medium text-[18px] text-[#1C2228] uppercase tracking-wide">
                  Total Order
                </TableHead>
                <TableHead className="text-center py-4 w-32 font-medium text-[18px] text-[#1C2228] uppercase tracking-wide">
                  Delivered
                ...
                <TableHead className="text-center py-4 w-40 font-medium text-[18px] text-[#1C2228] uppercase tracking-wide">
                  Action
                </TableHead>
              </TableRow>
            </TableHeader>
            ...
            <TableBody>
              {paginatedUsers.map((buyer) => (
                <TableRow key={buyer._id} className="border-[#B6B6B6] border-b">
                  ...
                  <TableCell className="text-center text-[18px] font-medium text-[#595959]">
                    {buyer.userName}
                  </TableCell>
                  <TableCell className="text-center text-[18px] font-medium text-[#595959]">
                    {buyer.totalOrders}
                  </TableCell>
                  <TableCell className="text-center text-[18px] font-medium text-green-600">
                    {buyer.delivered}
                  </TableCell>
                  <TableCell className="text-center text-[18px] font-medium text-orange-600">
                    {buyer.pending}
                  </TableCell>
                  <TableCell className="text-center text-[18px] font-medium text-red-600">
                    {buyer.cancelled}
                  </TableCell>
