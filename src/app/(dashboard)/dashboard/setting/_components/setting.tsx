            ...
            <Card>
                <div className='py-[52px] px-[32px]'>
                    ...
                    <CardContent className='p-0 space-y-5'>
                        ...
                        <div onClick={() => setIsOpen(true)} className='flex border cursor-pointer border-[#BABABA] rounded-md py-[18px] px-4  justify-between items-center'>
