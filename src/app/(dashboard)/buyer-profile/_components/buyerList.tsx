...
//         <div>
//             {/* Header Section */}
//             <div className="border-b border-[#B6B6B6] pb-7">
...
//                                     User Name
//                                 </TableHead>
//                                 <TableHead className="text-center py-4 font-semibold text-gray-700 text-sm uppercase tracking-wide w-32">
//                                     Total Order
//                                 </TableHead>
//                                 <TableHead className="text-center py-4 font-semibold text-gray-700 text-sm uppercase tracking-wide w-32">
//                                     Delivered
...
//                                     <TableCell className="text-center text-sm font-medium text-[#595959]">{user.id}</TableCell>
//                                     {/* User Profile */}
//                                     <TableCell className="py-4 flex items-center justify-center">
...
//                                             </Avatar>
//                                             <div>
//                                                 <p className=" text-[#595959] text-sm text-[16px] font-medium">
//                                                     {user.name}
//                                                 </p>
//                                             </div>
//                                         </div>
...
const BuyerList = () => {
    ...
    return (
        <div>
            {/* Header Section */}
            <div className="border-b flex justify-between items-center border-[#B6B6B6] pb-7">
                <div className="flex items-center justify-between">
                    <div>
                        <h1 className="text-2xl font-bold text-[#595959] mb-1">
                            Buyer Profile
